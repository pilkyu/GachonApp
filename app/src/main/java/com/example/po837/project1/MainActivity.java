...
import com.example.po837.project1.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentTranscation.replace(R.id.fragment, new CourseFragment());
...

        {
            ...
            public void onClick(View view) {
                ...
                FragmentManager fragmentManager = getSupportFragmentManager();
                FragmentTransaction fragmentTranscation = fragmentManager.beginTransaction();
                fragmentTranscation.replace(R.id.fragment, new StatisticsFragment());
                fragmentTranscation.commit();
            }
        });
...

        {
            ...
            public void onClick(View view) {
                ...
                FragmentManager fragmentManager = getSupportFragmentManager();
                FragmentTransaction fragmentTranscation = fragmentManager.beginTransaction();
                fragmentTranscation.replace(R.id.fragment, new ScheduleFragment());
                fragmentTranscation.commit();
            }
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            target = "http://po8375.cafe24.com/NoticeList.php";
        }
